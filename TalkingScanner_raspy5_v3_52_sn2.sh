#!/bin/bash
# Script TalkingScanner_raspy5_v3_52_sn2.sh RELEASE created by Sergey Znamenskiy 11/09/2026 intermittent error fix in left page crop
# supports cyrillic and english characters recognition
# speech syntethizer supports russian
# designed to work with scanner control script button_ctrl_takepic_undist_preproc_raspy5_v3_52_sn2.py 
...
echo "Привет, я читающий книжный сканер, версия 3.52" |RHVoice-test -p Aleksandr
...
python /usr/local/bin/button_ctrl_takepic_undist_preproc_raspy5_v3_52_sn2.py
